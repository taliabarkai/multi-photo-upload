import svgPaths from "./svg-8vdd84l1h8";
  ...
  return (
    <div className="h-[21.997px] relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex font-normal items-center justify-between not-italic relative size-full text-[14px]">
        ...
        <p className="leading-[18px] relative shrink-0 text-[#666]">0/3 uploaded</p>
      </div>
    </div>
  );
}
...
export default function MbDefaultView() {
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" data-name="MB Default View">
      <HeaderMb />
      <Frame9 />
    </div>
  );
