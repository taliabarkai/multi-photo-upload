import svgPaths from "./svg-idaexapksg";
...
function ProductCardImage() {
  return (
    <div className="overflow-clip relative shrink-0 size-[375px]" data-name="Product Card image">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgProductCardImage} />
    </div>
  );
}
...
function Container4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[1.997px] items-start min-h-px min-w-px relative" data-name="Container">
      <p className="font-semibold leading-[18px] not-italic relative shrink-0 text-[14px] text-black">Photo 1</p>
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <div aria-hidden="true" className="absolute border-b border-black border-solid inset-0 pointer-events-none" />
      <p className="font-semibold leading-[18px] not-italic relative shrink-0 text-[14px] text-black text-center">Replace</p>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[1.997px] items-start min-h-px min-w-px relative" data-name="Container">
      <p className="font-semibold leading-[18px] not-italic relative shrink-0 text-[14px] text-black">Photo 2</p>
    </div>
  );
}
...
function Container10() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[1.997px] items-start min-h-px min-w-px relative" data-name="Container">
      <p className="font-semibold leading-[18px] not-italic relative shrink-0 text-[14px] text-black">Photo 3</p>
    </div>
  );
}
...
export default function ImagesOnly() {
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" data-name="Images only">
      <HeaderMb />
      <Frame8 />
    </div>
  );
